...
parser.add_argument("--model", default="checkpoint/lapsrn_model_epoch_2.pth", type=str, help="model path")
...
ax.set_title("GT")
plt.savefig("result/GT.jpg",bbox_inches='tight')
plt.show()
ax = plt.subplot("132")
ax.imshow(im_b_y, cmap='gray')
ax.set_title("Input(Bicubic)")
plt.savefig("result/Input.jpg",bbox_inches='tight')
plt.show()
ax = plt.subplot("133")
ax.imshow(im_h_y, cmap='gray')
ax.set_title("Output(LapSRN)")
plt.savefig("result/Output.jpg",bbox_inches='tight')
