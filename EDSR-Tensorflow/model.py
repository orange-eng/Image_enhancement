...
class EDSR(object):
	...
	def __init__(self,img_size=32,num_layers=32,feature_size=256,scale=2,output_channels=3):
		...
		# self.input = x = tf.placeholder(tf.float32,[img_size,img_size,output_channels])
		...
		#self.target = y = tf.placeholder(tf.float32,[img_size*scale,img_size*scale,output_channels])
		"""
	...
	"""
	def train(self,iterations=2,save_dir="saved_models"):
