...
LR_folder=path + "/data/DIV2K_scale_sub/LR"
GT_folder=path + "/data/DIV2K_scale_sub/GT"

save_list=[path + "/data/DIV2K_scale_sub_psnr_LR_class3",
           path + "/data/DIV2K_scale_sub_psnr_LR_class2",
           path + "/data/DIV2K_scale_sub_psnr_LR_class1",
           path + "/data/DIV2K_scale_sub_psnr_GT_class3",
           path + "/data/DIV2K_scale_sub_psnr_GT_class2",
           path + "/data/DIV2K_scale_sub_psnr_GT_class1"]
for i in save_list:
    if os.path.exists(i):
        pass
    else:
