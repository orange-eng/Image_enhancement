...
def main():
    ...
    if mode == 'pair':
        # cut training data
        GT_folder = path + '/data/DIV2K800_scale/HR/x4'# fix to your path
        LR_folder = path + '/data/DIV2K800_scale/LR/x4'# fix to your path
        save_GT_folder = path + '/data/DIV2K_scale_sub/GT'
        save_LR_folder = path + '/data/DIV2K_scale_sub/LR'
        ...
        opt['input_folder'] = path + 'data/DIV2K_HR/DIV2K_valid_HR'
        opt['save_folder'] = path + '/DIV2K_valid_sub/GT'
