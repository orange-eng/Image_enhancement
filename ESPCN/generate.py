...
def get_arguments():
    ...
    parser.add_argument('--checkpoint', type=str,default=path+'/logdir_2x/train',
                        help='Which model checkpoint to generate from')
    parser.add_argument('--lr_image', type=str,default=path+'/result/lr.jpg',
                        help='The low-resolution image waiting for processed.')
    parser.add_argument('--hr_image', type=str,default=path+'/result/hr.jpg',
                        help='The high-resolution image which is used to calculate PSNR.')
    parser.add_argument('--out_path', type=str,default=path+'/result/result',
